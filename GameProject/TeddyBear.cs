...
namespace GameProject
{
    ...
    public class TeddyBear
    {
        ...
        // example of constructior deriving
        //public TeddyBear () : this(null, @"graphics\teddybear", GameConstants.WindowHeight/2, GameConstants.WindowWidth/2, new Vector2(), null, null)
        //{
        //   // here some exceptional code if needed
        //}
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (elapsedShotMilliseconds > firingDelay)
            {
                ...
                Projectile projectile = new Projectile(ProjectileType.TeddyBear, Game1.GetProjectileSprite(ProjectileType.TeddyBear), drawRectangle.Center.X,
                    drawRectangle.Bottom+GameConstants.TeddyBearProjectileOffset, GetProjectileYVelocity());
